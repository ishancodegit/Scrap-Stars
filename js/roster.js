...
const BRAWLERS = [
  {
    id: 'shelly', name: 'Shelly', cls: 'damage', art: 'shelly',
    ...
    hyper: { name: 'Clam Slam', charge: 4200, super: { count: 12, damage: 520, knockback: 460 } },
  },
  {
    id: 'colt', name: 'Colt', cls: 'damage', art: 'colt',
    ...
    hyper: { name: 'Silver Bullet', charge: 4200, super: { count: 12, damage: 420, pierce: true } },
  },
  {
    id: 'bull', name: 'Bull', cls: 'tank', art: 'bull',
    ...
    hyper: { name: 'Full Throttle', charge: 4600, super: { distance: 560, damage: 1400, knockback: 460 } },
  },
  {
    id: 'elprimo', name: 'El Primo', cls: 'tank', art: 'elprimo',
  ...
  },
  {
    ...
    hyper: { name: 'Trick Shot', charge: 4200, super: { count: 12, damage: 420, bounce: 8 } },
  },
  {
    id: 'barley', name: 'Barley', cls: 'artillery', art: 'barley',
    ...
    hyper: {
      name: 'Last Call', charge: 4200,
      super: { count: 6, puddle: { dps: 600, duration: 3.6, radius: 88 } },
    },
  },
  {
    id: 'poco', name: 'Poco', cls: 'support', art: 'poco',
    ...
    hyper: { name: 'Encore', charge: 4000, super: { teamRadius: 420, teamHeal: 3400, heal: 3400 } },
  },
  {
    id: 'piper', name: 'Piper', cls: 'marksman', art: 'piper',
  ...
  },
  {
    ...
    hyper: { name: 'Vampire Bats', charge: 4000, super: { count: 8, damage: 600, lifesteal: 0.7 } },
  },
  {
    id: 'spike', name: 'Spike', cls: 'damage', art: 'spike',
    ...
    hyper: {
      name: 'Cactus Cannon', charge: 4000,
